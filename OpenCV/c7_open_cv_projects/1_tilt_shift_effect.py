...
In this lesson we'll learn to:
    ...
    1:  Generate our Tilt Shift effect on our sample images
...
def get_images(sourcefolder):
    ...
    filenames = os.listdir(f'{sourcefolder}/original')
    for photo in filenames:
        black_img = cv2.imread(f'{sourcefolder}/original/' + photo)
        white_img = cv2.imread(f'{sourcefolder}/blur/' + photo)
        mask_img = cv2.imread(f'{sourcefolder}/mask/' + photo)
...
def main():
    ...
    sourcefolder = '../../SRC/images/tilt_shift'
    outfolder = '../../SRC/images/tilt_shift/output'
